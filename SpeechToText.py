...
class SpeechToText(object):
    def __init__(self, folder, file, cfgfile):
        ...
        config.read(cfgfile)
        # Set your own appid/apisecret/apikey in config.ini
        appid = config['ws-api.xfyun.cn']['appid']
        apisecret = config['ws-api.xfyun.cn']['apisecret']
        apikey = config['ws-api.xfyun.cn']['apikey']
        print("appid=" + appid)
